    ...
    for attempt in range(2):  # Retry once on failure
        try:
            response = client.chat.completions.create(
                ...
                temperature=0.4,   # Slightly higher for natural language; still deterministic enough
                max_tokens=1024,
                top_p=0.9,
            )
            ...
            break  # Don't retry on API-level errors (auth, quota, etc.)
